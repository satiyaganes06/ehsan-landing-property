...
function Switch(props: SwitchProps) {
  ...
  /* Radix's control props are for Root only. Spreading them onto the button
     underneath makes React warn that onCheckedChange is an unknown event
     handler, and they do nothing there -- Root already owns the state. */
